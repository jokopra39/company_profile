...
echo "
    ...
    <div class='modal-dialog modal-dialog'>
      <div class='modal-content'>
		...
		<a href='#'  rel='$idne' class='list-group-item' id='aaaaa'><span class='glyphicon glyphicon-print'></span> &nbsp; PRINT</a>
		
		<a href='#'  rel='$idne' class='list-group-item' id='bbbbb'><span class='glyphicon glyphicon-edit'></span> &nbsp; EDIT</a>
		
		<a  href='#'  rel='$idne/$ok' class='list-group-item' id='delku'><span class='glyphicon glyphicon-remove'></span> &nbsp; DELETE</a>
...
//$("#detail-dialog").load('exp.php?F1='+F1);
if (idx == 'delku'){
if (confirm('Apakah anda ingin menghapus data '+ so+' ?')) {
   //alert (arr[0]);
  window.location.replace('delete.php?ID='+jo+'&SOP='+so);
